...
import { NbCalendarYearCellComponent, NbDateService, NbSelectComponent, NbStepperComponent, NbToastrService } from '@nebular/theme';
...
export class FormationComponent implements OnInit, OnDestroy{
  ...
  constructor(protected dateService: NbDateService<Date>, private httpDomaineService: HttpDomaineService, 
    ...
    private httpSessionService: HttpSessionService, private toast: NbToastrService) { 
  ...
  test(nameForm: NgForm,stepper: NbStepperComponent){
    ...
    setTimeout(() =>{
      ...
      this.toast.control("Max Sessions Reached", "Control", {duration: 5000})
